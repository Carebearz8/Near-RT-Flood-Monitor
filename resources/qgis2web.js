...
map.getView().fit([-6913185.493241, 1096401.499007, -6692769.801598, 1247030.972491], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Trinidad Near-Real Time Monitoring Thresholds Map</h2>';
        return titleElement;
    })(),
